...
namespace Core.Security.Contracts
{
    ...
    public interface ISecurityUserManager : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        IIdentityValidator<SecurityUser> UserValidator { get; set; }
        ...
        /// </summary>
        IClaimsIdentityFactory<SecurityUser, Guid> ClaimsIdentityFactory { get; set; }
        ...
        /// </summary>
        IUserTokenProvider<SecurityUser, Guid> UserTokenProvider { get; set; }
        ...
        /// </summary>
        IQueryable<SecurityUser> Users { get; }

        /// <summary>
        /// Maps the registered two-factor authentication providers for users by their id
        /// </summary>
        IDictionary<string, IUserTokenProvider<SecurityUser, Guid>> TwoFactorProviders { get; }
        ...
        /// <returns/>
        Task<ClaimsIdentity> CreateIdentityAsync(SecurityUser user, string authenticationType);
        ...
        /// <param name="user"/>
        /// <returns/>
        Task<IdentityResult> CreateAsync(SecurityUser user);
        ...
        /// <param name="user"/>
        /// <returns/>
        Task<IdentityResult> UpdateAsync(SecurityUser user);
        ...
        /// <param name="user"/>
        /// <returns/>
        Task<IdentityResult> DeleteAsync(SecurityUser user);
        ...
        /// <param name="userId"/>
        /// <returns/>
        Task<SecurityUser> FindByIdAsync(Guid userId);
        ...
        /// <param name="userName"/>
        /// <returns/>
        Task<SecurityUser> FindByNameAsync(string userName);
        ...
        /// <returns/>
        Task<SecurityUser> FindAsync(string userName, string password);
        ...
        /// <param name="user"/><param name="password"/>
        /// <returns/>
        Task<bool> CheckPasswordAsync(SecurityUser user, string password);
        ...
        /// </summary>
        /// <returns/>
        Task<SecurityUser> FindAsync(UserLoginInfo login);
        ...
        /// <param name="email"/>
        /// <returns/>
        Task<SecurityUser> FindByEmailAsync(string email);
        ...
        void RegisterTwoFactorProvider(string twoFactorProvider, IUserTokenProvider<SecurityUser, Guid> provider);
        ...
        /// <param name="userId"/>
        /// <returns/>
        Task<Guid> GetAccessFailedCountAsync(Guid userId);
        ...
        Task<ClaimsIdentity> GenerateUserIdentityAsync(SecurityUser SecurityUser);
