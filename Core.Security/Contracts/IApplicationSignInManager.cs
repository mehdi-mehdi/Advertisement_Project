...
namespace Core.Security.Contracts
{
    public interface IApplicationSignInManager : IDisposable
    {
        ...
        /// </summary>
        /// <param name="securityUser"/>
        /// <returns/>
        Task<ClaimsIdentity> CreateUserIdentityAsync(SecurityUser securityUser);
        ...
        /// </summary>
        /// <param name="securityUser"/><param name="isPersistent"/><param name="rememberBrowser"/>
        /// <returns/>
        Task SignInAsync(SecurityUser securityUser, bool isPersistent, bool rememberBrowser);
